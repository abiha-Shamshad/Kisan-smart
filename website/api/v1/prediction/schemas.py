...
class PredictionRequestSchema(Schema):
    ...
    growth_stage = fields.Str(required=True, validate=validate.OneOf(['Initial', 'Vegetative', 'Flowering', 'Maturity']))
    farm_area = fields.Float(required=True, validate=validate.Range(min=0.1, max=1000.0))
